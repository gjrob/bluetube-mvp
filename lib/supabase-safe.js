...
/** Browser-only client (React components) — returns the shared singleton. */
...
function makePublicClient() {
  // In the browser, always reuse the shared singleton (one GoTrueClient).
  if (typeof window !== 'undefined') return browserSingleton;
